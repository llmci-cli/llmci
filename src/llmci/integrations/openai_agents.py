"""Convert OpenAI Agents SDK runs into llmci agent eval output."""
...
def llmci_input_to_agent_input(input_data: dict[str, Any]) -> str | list[dict[str, Any]]:
    """Map llmci agent eval input to OpenAI Agents SDK runner input."""
...
def llmci_output_from_run_result(result: Any) -> dict[str, Any]:
    """Convert an OpenAI Agents ``RunResult`` into llmci trace JSON."""
